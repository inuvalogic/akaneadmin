...
//###### Config ######
$absPthToSlf = SITEURL.'tiny_mce/tinyupload.php'; //The Absolute path (from the clients POV) to this file.
$absPthToDst = MAINSITEURL.NEWS_PIC_DIR; //The Absolute path (from the clients POV) to the destination folder.
$absPthToDstSvr = '../../'.NEWS_PIC_DIR; //The Absolute path (from the servers POV) to the destination folder. You will need to set permissions for this dir 0777 worked ok for me.
