...
{
    $config['img_path'] = 'assets/uploads';
    $config['base_image_url'] = 'http://www.websiteutama.com/';
    $config['relative_path'] = '/../';
} else {
    $config['img_path'] = 'assets/uploads';
    $config['base_image_url'] = 'http://localhost/websiteutama/';
    $config['relative_path'] = '/../websiteutama/';
}
